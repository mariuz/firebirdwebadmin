    ...
    <form method="post" action="<?php echo url_session($_SERVER['PHP_SELF']) . '#dt_export'; ?>" name="dt_csv_form" enctype="multipart/form-data">
        <table class="table table-bordered">
            ...
            <span id="dt_export_filename_span" style="display:<?php $s_export['target']['option'] == 'file' ? print 'block' : print 'none'; ?>;">
              <?php echo get_textfield('dt_export_target_filename', 30, 255, $s_export['target']['filename'], 'text', array('id' => 'dt_export_target_filename')); ?>
                &nbsp;&nbsp;<?php echo $dt_strings['EntName']; ?>
            </span>
                            </td>
                        </tr>
                    </table>
        ...
        <table class="table table-bordered">
            ...
            <tr>
                <td>
                    <input type="submit" class="btn btn-default" name="dt_export_doit" value="<?php echo $button_strings['Export']; ?>">
                </td>
                <td align="right">
                    <input type="submit" class="btn btn-default" name="dt_export_defaults" value="<?php echo $button_strings['Defaults']; ?>">
                </td>
            </tr>
        </table>
