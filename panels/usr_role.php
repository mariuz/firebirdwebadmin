...
if (isset($s_confirmations['role'])) {
    ...
    <form method="post" action="<?php echo url_session($_SERVER['PHP_SELF']); ?>" name="usr_role_form">
        ...
        <table class="table table-bordered">
            ...
            <table class="table table-bordered">
                <tr>
                    <th align="left"><strong><?php echo $usr_strings['CreateRole']; ?></strong></th>
                    <td><strong><?php echo $usr_strings['Name']; ?></strong><br>
                ...
                <tr>
                    <th align="left"><strong><?php echo $usr_strings['RoleSelDel']; ?></strong></th>
                    <td>
                        <strong><?php echo $usr_strings['Name']; ?></strong><br>
