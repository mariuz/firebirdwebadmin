...
if ($s_connected):
    ...
    <form method="post" action="<?php echo url_session($_SERVER['PHP_SELF']); ?>" name="dt_import_form" enctype="multipart/form-data">
        <table class="table table-bordered">
            <tr>
                <th><?php echo $dt_strings['SelTable']; ?></th>
                <th><?php echo $dt_strings['FileName']; ?></th>
                <th>&nbsp;</th>
            <tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="submit" class="btn btn-default" name="dt_import_doit" value="<?php echo $button_strings['Import']; ?>">
                </td>
            </tr>
        </table>
