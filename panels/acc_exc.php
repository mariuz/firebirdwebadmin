...
<form method="post" action="<?php echo url_session($_SERVER['PHP_SELF']);
    ?>" name="create_exc_form">
<table border cellpadding="3" cellspacing="0">
  <tr>
    <th align="left"><?php echo $acc_strings['CreateExc'];
    ?></th>
  </tr>
  <tr>
    <td>
      <b><?php echo $acc_strings['Name'];
    ?></b><br>
  ...
  <tr>
    <td>
      <b><?php echo $acc_strings['Message'];
    ?></b><br>
...
<input type="submit" name="acc_exc_create_doit" value="<?php echo $button_strings['Create'];
    ?>" class="bgrp">
<input type="reset" name="acc_exc_create_clear" value="<?php echo $button_strings['Reset'];
    ?>" class="bgrp">
<input type="submit" name="acc_exc_create_cancel" value="<?php echo $button_strings['Cancel'];
    ?>" class="bgrp">
</form>
<?php
...
<table border cellpadding="3" cellspacing="0">
  <tr>
    <th align="left"><?php echo  sprintf($acc_strings['ModExc'], $s_exception_defs['name']);
    ?></th>
  </tr>
  <tr>
    <td>
...
<input type="submit" name="acc_exc_mod_doit" value="<?php echo $button_strings['Save'];
    ?>" class="bgrp">
<input type="reset" name="acc_exc_mod_clear" value="<?php echo $button_strings['Reset'];
    ?>" class="bgrp">
<input type="submit" name="acc_exc_mod_cancel" value="<?php echo $button_strings['Cancel'];
    ?>" class="bgrp">
</form>
<?php
...
<table border cellpadding="3" cellspacing="0">
<tr>
  <th colspan="2" align="left"><?php echo $acc_strings['CreateExc'];
    ?></th>
...
<tr>
  <td>
    <b><?php echo $acc_strings['SelExcMod'];
    ?></b>
  </td>
  <td>
...
<tr>
  <td>
    <b><?php echo $acc_strings['SelExcDel'];
    ?></b>
  </td>
  <td>
