      ...
      <table cellpadding="3" border="1">
        ...
        <tr>
          <td>
            ...
            <input type="submit" name="adm_gfix_use_space" value="<?php echo $button_strings['Set']; ?>">
          </td>
        </tr>
      </table>
    </td>
...
<tr>
  <td><?php echo  $adm_strings['SetInterv']; ?>&nbsp;
    <input type="text"  size="9" maxlength="8" name="adm_housekeeping" value="<?php echo $s_gfix['sweep_interval']; ?>">
...
<tr>
  ...
  <td width="20">&nbsp;</td>
  <td>
    <input type="submit" name="adm_gfix_repair" value="<?php echo $button_strings['Execute']; ?>">
  </td>
</tr>
</table>
<br>
